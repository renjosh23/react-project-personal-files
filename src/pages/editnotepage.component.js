...
const EditNotePage = ({ match, history, dispatchCreateNoteAction, dispatchGetNoteByIdAction, dispatchUpdateNoteAction }) => {
    ...
    const [error, setError] = useState({ title: false, content: false, description: false });
    ...
    const isFormInvalid = () => (!title.trim() || !content.trim() || !description.trim());

    const updateErrorFlags = () => {
        const errObj = { title: false, content: false, description: false };
                    ...
                    <form noValidate onSubmit={handleOnSubmit}>
                        <div className="form-group">
                            ...
                            <input noValidate id="title"
                                type="text"
                                placeholder="What skills you have in company"
                                name="title"
                                value={title}
                        ...
                        <div className="form-group">
                            <label htmlFor="category">Job Role Position</label>
                            <select noValidate id="category"
                                ...
                                <option value="GENERAL">Front End Developer</option>
                                <option value="IDPROOF">Back End Devloper</option>
                                <option value="PROFESSIONAL">FullStack Developer</option>
                            </select>
                            <p className="invalid-feedback">Required</p>
                        </div>
