        ...
        <React.Fragment>
            <div className="row my-5">
                <div className="col-10">
                    <h2>Lists of Profile</h2>
                </div>
                <div className="col-2">
                    <Link to="/edit-note" className="btn btn-primary">
                        Add Profile | <i className="fas fa-plus"></i>
                    </Link>
                </div>
            </div>
                ...
                <div className="col-12">
                    {
                        notes.length > 0 ? <NotesCollection notes={notes} /> :
                            <div className="text-center mt-5">
                                ...
                                <h1 className="text-center">You don't have any profile lists</h1>
                                <h1 className="text-center">Create your profile now</h1>
                            </div>
                    }
                </div>
            </div>
